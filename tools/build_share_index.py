...
# ⚠ 这些书的词条名本身就是露骨描述（"骑乘口交""夫目前犯"…），出卡等于把内容摘要
#   贴进聊天窗口给全群看，点都不用点。安全本里的门控词条不同，标题是"R18 0261"
#   这类编号，不受此开关影响、始终只给标题。维护者 2026-09-01 拍板开启；
#   要退回"整本 NSFW 一律通用站点卡"，把这里改成 False 后重建索引即可。
TITLE_ONLY_NSFW_BOOKS = True
